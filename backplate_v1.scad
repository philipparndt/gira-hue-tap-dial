...
//    translate([0,frame_width-frame_part_width,0])
//        translate([(frame_width-23)/2 - cutout_size/2, 0, frame_height - 1 + .01]) {
//            translate([0, 0, 0])
//                cube([cutout_size, frame_part_width, 1], center=false);
//
//            translate([23, 0, 0])
//                cube([cutout_size, frame_part_width, 1], center=false);
//        }
